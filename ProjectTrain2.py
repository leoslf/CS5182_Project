...
fname = 'data.pickle'
#prepare_datasets(dir, threshold, fname)
...
#print (xtrain[0])
ytrain = to_categorical(y_train, no_classes)

from projectModel import *

model = model_v3((18,18,18,3), classQTY = no_classes, rate = 0.0025)

model.summary()

monitor = EarlyStopping(monitor='val_loss', min_delta =0.01, patience = 50, verbose = 0,
...
model.save("simpleCNN_t16_v3.h5")
df = pd.DataFrame(history.history)
filename = 'history_simpleCNN_t16_v3.csv'
